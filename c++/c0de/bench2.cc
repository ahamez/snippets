...
int main(int argc, char** argv)
{
  ...
  auto k3 = vector_type{};
  // std::fill(begin(k3), end(k3), 3);
  auto k4 = vector_type{};
  // std::fill(begin(k4), end(k4), 3);
  ...
  std::cout << "R1 R2 Rate      : " << (4096*nb_loops)/1024/1024/duration.count()
            << " bytes/s\n";
 
  return std::equal(begin(r1), end(r1), begin(r2));
}
